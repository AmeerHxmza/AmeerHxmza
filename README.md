...
### → [Explore my portfolio & projects](https://ameerhamza-portfoliosite.vercel.app/)
...
Built around structured recruitment workflows with AI-powered analysis and a production-oriented application architecture.
...
AI application for extracting and interpreting medical lab reports using a hybrid **GenAI + retrieval + structured processing** workflow.
...
### [Explore all projects & case studies →](https://ameerhamza-portfoliosite.vercel.app/)
...
|---|---|
| **Agentic AI** | LangGraph, CrewAI, tool calling, multi-agent orchestration, stateful workflows |
...
| **Voice AI** | Whisper STT, ElevenLabs TTS, conversational agents |
| **AI Backends** | Python, FastAPI, REST APIs, asynchronous AI workflows |
| **Data & Retrieval** | PostgreSQL, Supabase, vector search, document processing |
